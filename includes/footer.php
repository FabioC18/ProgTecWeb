<footer id="footer"><!-- individua l'unico elemento footer nella pagina-->
    <div class="info"> <!-- contenitore generico (div): identifica un gruppo di elelementi. Viene usato in css-->
    ...
    <div class="social">
        <h1>Social <br></h1>
        <h2>
            <a class="ig" href="https://www.instagram.com/salernomareeluci?igsh=a253aHZ6cXE1YW56"> <!-- collegamento cliccabile ad un altra pagina con destinazione associata tramite href-->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.518 31.51" > <!-- icona instagram-->
        ...
        <h2>
            ...
            <a class="fb" href="https://www.facebook.com/share/16ow7kgKgY/?mibextid=wwXIfr"> <!-- collegamento cliccabile ad un altra pagina con destinazione associata tramite href--> 
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.702 31.51"> <!-- icona facebook-->
        ...
        <h2>
            <a class="tk" href="https://www.tiktok.com/@salernomareeluci?_r=1&_t=ZN-93hbMdaFklK">  <!-- collegamento cliccabile ad un altra pagina con destinazione associata tramite href--> 
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" version="1.1"> <!-- icona tiktok -->
